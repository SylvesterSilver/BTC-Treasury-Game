export interface Era {
  ...
  interestRate: number;        // annual rate on convertible debt (e.g. 0.06 = 6%)
  macroEnv: string;            // short macro description for UI
}
...
export const ERAS: Era[] = [
  {
    ...
    historicalPrices: historicalCurve(13, 1100, 180, [
      { day: 60, price: 50 }, { day: 90, price: 150 }, { day: 120, price: 266 },
      { day: 140, price: 180 }, { day: 160, price: 1150 },
    ], 0.04),
    volatility: 1.8, drift: 2.5, jumpFreq: 8, jumpMean: 0.12, jumpStd: 0.25,
    ...
    softwareRevenue: 3,
    interestRate: 0.04,
    macroEnv: 'Low rates · QE era · 10yr @ 2%',
  },
  {
    id: 'bull2017',
    name: '2017 EUPHORIA',
    ...
    historicalPrices: historicalCurve(998, 19500, 180, [
      { day: 40, price: 1800 }, { day: 80, price: 2900 }, { day: 110, price: 4900 },
      { day: 140, price: 7500 }, { day: 165, price: 19500 },
    ], 0.035),
    volatility: 1.4, drift: 3.2, jumpFreq: 6, jumpMean: 0.1, jumpStd: 0.2,
    ...
    softwareRevenue: 8,
    interestRate: 0.045,
    macroEnv: 'Fed hiking · 10yr rising · Risk-on',
  },
  {
    id: 'bear2018',
    ...
    historicalPrices: historicalCurve(13800, 3200, 180, [
      { day: 20, price: 11000 }, { day: 50, price: 9000 }, { day: 80, price: 6800 },
      { day: 120, price: 4200 }, { day: 160, price: 3200 },
    ], 0.04),
    volatility: 1.2, drift: -0.8, jumpFreq: 4, jumpMean: -0.08, jumpStd: 0.18,
  ...
  },
  {
    ...
    historicalPrices: historicalCurve(7200, 29000, 180, [
      { day: 30, price: 9100 }, { day: 60, price: 4900 }, { day: 70, price: 6500 },
      { day: 100, price: 9000 }, { day: 130, price: 12000 },
      { day: 160, price: 20000 }, { day: 175, price: 29000 },
    ], 0.03),
    volatility: 1.1, drift: 1.8, jumpFreq: 5, jumpMean: 0.06, jumpStd: 0.22,
    description: 'March 2020: Bitcoin crashes 50% in a day. Then MicroStrategy enters. Time the accumulation.',
    ...
    softwareRevenue: 25,
    interestRate: 0.02,
    macroEnv: 'Emergency cuts · Fed at 0% · QE infinity',
  },
  {
    id: 'bull2021',
    ...
    historicalPrices: historicalCurve(29000, 47000, 180, [
      { day: 30, price: 38000 }, { day: 60, price: 58000 }, { day: 75, price: 65000 },
      { day: 90, price: 48000 }, { day: 120, price: 34000 },
      { day: 150, price: 47000 }, { day: 175, price: 67000 },
    ], 0.03),
    volatility: 0.9, drift: 0.8, jumpFreq: 5, jumpMean: 0.05, jumpStd: 0.18,
    description: 'Institutions pile in. Two ATH runs, one brutal 54% correction in May. Time your moves.',
    difficulty: 'MEDIUM', difficultyColor: '#f59e0b',
    startingBTC: 70470, startingCash: 300, startingDebt: 2200, startingShares: 160, startingPreferred: 0,
    softwareRevenue: 30,
    interestRate: 0.025,
    macroEnv: 'Fed still dovish · Rates near 0 · Stimulus era',
  },
  {
    id: 'bear2022',
    ...
    historicalPrices: historicalCurve(46000, 16500, 180, [
      { day: 20, price: 43000 }, { day: 60, price: 38000 }, { day: 90, price: 28000 },
      { day: 110, price: 22000 }, { day: 150, price: 20000 }, { day: 165, price: 16500 },
    ], 0.04),
    volatility: 1.0, drift: -1.2, jumpFreq: 6, jumpMean: -0.12, jumpStd: 0.2,
    description: 'LUNA implodes. FTX blows up. BTC falls 65%. Preferred dividends don\'t stop.',
    difficulty: 'LEGENDARY', difficultyColor: '#a855f7',
    startingBTC: 129218, startingCash: 60, startingDebt: 2400, startingShares: 180, startingPreferred: 100,
    softwareRevenue: 28,
    interestRate: 0.075,
    macroEnv: 'Fed hiking 75bps/meeting · 10yr @ 4.2% · Liquidity crisis',
  },
  {
    id: 'now2024',
    ...
    historicalPrices: historicalCurve(42000, 105000, 180, [
      { day: 40, price: 52000 }, { day: 70, price: 73000 }, { day: 90, price: 57000 },
      { day: 120, price: 67000 }, { day: 150, price: 89000 }, { day: 170, price: 105000 },
    ], 0.025),
    volatility: 0.75, drift: 1.2, jumpFreq: 4, jumpMean: 0.07, jumpStd: 0.15,
    ...
    softwareRevenue: 30,
    interestRate: 0.065,
    macroEnv: 'Fed cutting · 10yr @ 4.5% · Risk-on return',
  },
  {
    id: 'future2025',
    ...
    historicalPrices: [],
    volatility: 0.8, drift: 0.9, jumpFreq: 4, jumpMean: 0.05, jumpStd: 0.16,
    description: 'No past to anchor you. Pure stochastic projection from today. Navigate uncertainty.',
    difficulty: 'HARD', difficultyColor: '#ef4444',
    startingBTC: 220000, startingCash: 1200, startingDebt: 8500, startingShares: 260, startingPreferred: 2500,
    softwareRevenue: 30,
    interestRate: 0.055,
    macroEnv: 'Unknown macro · Rate trajectory unclear',
  },
];
